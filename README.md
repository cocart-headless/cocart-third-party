<h1 align="center">CoCart - Third Party Package</h1>

<p align="center"><img src="https://cocart.xyz/wp-content/uploads/2021/11/cocart-home-default.png.webp" alt="CoCart Logo" /></p>

<br>

This is a package for CoCart that provides support for specific plugins, WooCommerce extensions and web hosts.

It is designed to be pulled in via Composer when CoCart is compiled for a plugin build release.

Any third party requirements are controlled and maintained in this package.
...
CoCart Third Party Package is developed and maintained by [Sébastien Dumont](https://github.com/seb86).
